    ...
    public void writeVLong(long value) {
        if(value < 0) {
            ...
            if(value > 0xFFFFFFFFFFFFFFL) {
                writeByte((byte)(0x80 | ((value >>> 56) & 0x7FL)));
            }
            if(value > 0x1FFFFFFFFFFFFL) {
                writeByte((byte)(0x80 | ((value >>> 49) & 0x7FL)));
            }
            if(value > 0x3FFFFFFFFFFL) {
                writeByte((byte)(0x80 | ((value >>> 42) & 0x7FL)));
            }
            if(value > 0x7FFFFFFFFL) {
                writeByte((byte)(0x80 | ((value >>> 35) & 0x7FL)));
            }
            if(value > 0xFFFFFFFL) {
                writeByte((byte)(0x80 | ((value >>> 28) & 0x7FL)));
            }
            if(value > 0x1FFFFFL) {
                writeByte((byte)(0x80 | ((value >>> 21) & 0x7FL)));
            }
            if(value > 0x3FFFL) {
                writeByte((byte)(0x80 | ((value >>> 14) & 0x7FL)));
            }
            if(value > 0x7FL) {
                writeByte((byte)(0x80 | ((value >>> 7) & 0x7FL)));
            }
